...
def main():
    ...
    best_model = BodyFatRegressor(
        input_dim=data.shape[1] - 1, learning_rate=study.best_params["learning_rate"], hidden_layer_1=study.best_params["hidden_layer_1"], hidden_layer_2=study.best_params["hidden_layer_2"], dropout_rate=study.best_params["dropout_rate"], weight_decay=study.best_params["weight_decay"]
    )
